...
public class S3Controller {
    ...
    @PostMapping("/api/upload") PostImage uploadImage(@RequestParam(value = "file") MultipartFile multipartFile) throws IOException {
    ...
    @PostMapping("/test") String testUpload(@RequestParam(value = "file", required = false) MultipartFile multipartFile) {
        s3Uploader.test(multipartFile, "test");
